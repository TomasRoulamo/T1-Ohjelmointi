...
{
    public partial class TietoForm : Form
    {
        public TietoForm()
        {
            InitializeComponent();
        ...
        private void OppilaitosCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PnroLB.Text = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OPostinumero"].ToString();
            PpaikkaLB.Text = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OPostitoimipaikka"].ToString();
            ...
            VastuuCB.DataSource = yhteys;
            VastuuCB.DisplayMember = "Vnimi";
        }

        private void TietoForm_Load(object sender, EventArgs e)
        {
            taytaOppilaitosTaulukko();
            OppilaitosCB.DataSource = oppilaitos;
            OppilaitosCB.DisplayMember = "Onimi";
            taytaVHenkilotTaulukko();
        }

        private void VastuuCB_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void taytaVHenkilotTaulukko()
        {
        ...
        private void VastuuCB_TextChanged(object sender, EventArgs e)
        {

            TitteliLB.Text = yhteys.Rows[VastuuCB.SelectedIndex]["VTitteli"].ToString();
            OsastoLB.Text = yhteys.Rows[VastuuCB.SelectedIndex]["VSijainti"].ToString();
            EmailLB.Text = yhteys.Rows[VastuuCB.SelectedIndex]["VSahkoposti"].ToString();
            PuhLB.Text = yhteys.Rows[VastuuCB.SelectedIndex]["VPuhelin"].ToString();
        }
    }
}
